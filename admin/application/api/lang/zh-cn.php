...
return [
    ...
    'memberdatanull'                                 => '没有找到该用户',
    'datasumitsuccess'                               => '数据提交成功',
    'datasumiterror'                                 => '数据提交失败',
    'datanull'                                       => '数据为空',
    'groupnull'                                      => '没有找到该群组信息',
    'crategroupsuccess'                              => '群组收录成功',
    'crategrouperror'                                => '群组收录失败',
    'pagenulldata'                                   => '请先配置开始按钮',
    'crateordererror'                                => '创建订单失败',
    'queryordersuccess'                              => '订单查询成功',
    'queryordererror'                                => '订单查询失败',
    'advtypelist'                                    => '可投广告列表',
    'advlistsuccess'                                 => '广告列表查询成功',
    'existencemsg'                                   => '已存在该消息',
    'msgwritesuccess'                                => '消息写入成功',
    'msgwriteerror'                                  => '消息写入失败',
    'getsellsuccess'                                 => '获取售出列表成功',
    'getcjadvsuccess'                                => '获取采集广告成功',
    'seachinfow'                                     => '搜索者信息已被记录'
